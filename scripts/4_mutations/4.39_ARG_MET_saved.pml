    ...
    select contact, resi 134 and 6TKO and ! chain R
    ...
    # label first (n. CA & chain R and resi 60 and 6OS2_6TKO) , resi+resn+' %1.2f'%b
    set # label_color, violetpurple, first (n. CA & chain R and resi 60 and 6OS2_6TKO)
