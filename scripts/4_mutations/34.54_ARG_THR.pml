    ...
    label (n. CA & chain R and contact_orig_res and 6UP7) , resi+resn+' %1.2f'%b
    set label_color, grey20, (n. CA & chain R and contact_orig_res and 6UP7)
    label first (n. CA & chain R and contact_orig_res and ! 6UP7) , resi+resn+' %1.2f'%b
    set label_color, violetpurple, first (n. CA & chain R and contact_orig_res and ! 6UP7)
