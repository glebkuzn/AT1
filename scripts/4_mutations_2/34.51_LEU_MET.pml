    ...
    show cartoon, 6U1N
    select init_res, 6U1N and chain A and (resi 140)
    ...
    # select contact, resi 140 and 6U1N and ! chain R
    ...
    # label first (n. CA & chain R and contact_orig_res and ! 6U1N) , resi+resn+' %1.2f'%b
    # set label_color, violetpurple, first (n. CA & chain R and contact_orig_res and ! 6U1N)
