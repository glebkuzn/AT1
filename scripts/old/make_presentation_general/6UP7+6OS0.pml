    ...
    util.cbak 6OS0_GPCRDB & n. c+ca
    util.cbac only_arrs & n. c+ca
    label first 6OS0_GPCRDB, '6OS0'

    align 6UP7, only_arrs
    align 6OS0_GPCRDB, 6UP7
    remove 6UP7
    ...
    viewport 800,800
    ray
    png ../../images/presentation_general/6OS0_6UP7_1.png
    rotate [0,1,0], 180, all
    ray
    png ../../images/presentation_general/6OS0_6UP7_2.png
    bg_color white
