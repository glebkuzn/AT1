    ...
    align 6OS2_GPCRDB, 6UP7
    remove 6UP7
    remove only_arrs and ! chain C

    select '282', resi 282 and only_arrs
    distance 282_polar, 282, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 283_polar, 283, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 284_polar, 284, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 285_polar, 285, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 133_polar, 133, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 134_polar, 134, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 135_polar, 135, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 136_polar, 136, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 137_polar, 137, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 244_polar, 244, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 245_polar, 245, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 246_polar, 246, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 247_polar, 247, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 248_polar, 248, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 65_polar, 65, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 66_polar, 66, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 67_polar, 67, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 68_polar, 68, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 69_polar, 69, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 70_polar, 70, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 71_polar, 71, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 72_polar, 72, 6OS2_GPCRDB, 4, mode=2
    ...
    distance 73_polar, 73, 6OS2_GPCRDB, 4, mode=2
    ...
    deselect
    orient 6OS2_GPCRDB + only_arrs
    viewport 1024,768
    bg_color white
    ray
    set label_size, 20
    png ../../images/presentation/6UP7_6OS2.png
