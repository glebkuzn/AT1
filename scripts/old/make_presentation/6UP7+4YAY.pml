    ...
    align 4YAY_GPCRDB, 6UP7
    remove 6UP7
    remove only_arrs and ! chain C

    select '282', resi 282 and only_arrs
    distance 282_polar, 282, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 283_polar, 283, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 284_polar, 284, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 285_polar, 285, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 133_polar, 133, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 134_polar, 134, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 135_polar, 135, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 136_polar, 136, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 137_polar, 137, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 244_polar, 244, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 245_polar, 245, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 246_polar, 246, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 247_polar, 247, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 248_polar, 248, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 65_polar, 65, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 66_polar, 66, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 67_polar, 67, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 68_polar, 68, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 69_polar, 69, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 70_polar, 70, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 71_polar, 71, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 72_polar, 72, 4YAY_GPCRDB, 4, mode=2
    ...
    distance 73_polar, 73, 4YAY_GPCRDB, 4, mode=2
    ...
    deselect
    orient 4YAY_GPCRDB + only_arrs
    viewport 1024,768
    bg_color white
    ray
    set label_size, 20
    png ../../images/presentation/6UP7_4YAY.png
